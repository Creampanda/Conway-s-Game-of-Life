...
class Grid:
    def __init__(self, width, height, scale, offset):
        ...
        self.grid_array = np.zeros(shape=(self.size))
        self.offset = offset

    def make_line(self, x, y):
        self.grid_array[x][y] = 1
        self.grid_array[x+1][y] = 1
        self.grid_array[x+2][y] = 1

    def make_glider(self,x,y):
        self.grid_array[x][y] = 1
        self.grid_array[x+1][y] = 1
        self.grid_array[x+2][y] = 1
        self.grid_array[x+2][y-1] = 1
        self.grid_array[x+1][y-2] = 1

    def rand2d_array(self):
    ...
    def get_neighbours(self, x, y):
        ...
        # print("for [{}][{}] there are {} neighbours".format(x, y, total))
        return total